...
foreign {
  ...
  */
  abort_ext :: proc(file: ^char, function: ^char, line: i32, fmt: ^char, #c_vararg args: ..any) ---
  /*
  ...
  */
  assert_fail :: proc(file: ^char, function: ^char, line: i32, src: ^char, fmt: ^char, #c_vararg args: ..any) ---
  ...
  */
  log_ext :: proc(level: log_level, function: ^char, file: ^char, line: i32, fmt: ^char, #c_vararg args: ..any) ---
}
...
foreign {
  ...
  str8_push_cstring :: proc(arena: ^arena, str: ^char) -> str8 ---
  str8_push_copy :: proc(arena: ^arena, s: str8) -> str8 ---
  str8_push_slice :: proc(arena: ^arena, s: str8, start: u64, end: u64) -> str8 ---
  str8_pushfv :: proc(arena: ^arena, format: ^char, args: va_list) -> str8 ---
  str8_pushf :: proc(arena: ^arena, format: ^char, #c_vararg args: ..any) -> str8 ---
  str8_cmp :: proc(s1: str8, s2: str8) -> i32 ---
  str8_to_cstring :: proc(arena: ^arena, _string: str8) -> ^char ---
  str8_list_push :: proc(arena: ^arena, list: ^str8_list, str: str8) ---
  str8_list_pushf :: proc(arena: ^arena, list: ^str8_list, format: ^char, #c_vararg args: ..any) ---
...
foreign {
  ...
  utf8_encode :: proc(dst: ^char, codePoint: utf32) -> str8 ---
  utf8_to_codepoints :: proc(maxCount: u64, backing: ^utf32, _string: str8) -> str32 ---
  utf8_from_codepoints :: proc(maxBytes: u64, backing: ^char, codePoints: str32) -> str8 ---
...
foreign {
  ...
  ui_label :: proc(label: ^char) -> ui_sig ---
  ui_label_str8 :: proc(label: str8) -> ui_sig ---
  ui_button :: proc(label: ^char) -> ui_sig ---
  ui_checkbox :: proc(name: ^char, checked: ^bool) -> ui_sig ---
  ui_slider :: proc(name: ^char, value: ^f32) -> ^ui_box ---
  ui_scrollbar :: proc(name: ^char, thumbRatio: f32, scrollValue: ^f32) -> ^ui_box ---
  ui_tooltip :: proc(label: ^char) ---
  ui_panel_begin :: proc(name: ^char, flags: ui_flags) ---
  ui_panel_end :: proc() ---
  ui_menu_bar_begin :: proc(name: ^char) ---
  ui_menu_bar_end :: proc() ---
  ui_menu_begin :: proc(label: ^char) ---
  ui_menu_end :: proc() ---
  ui_menu_button :: proc(label: ^char) -> ui_sig ---
  ui_text_box :: proc(name: ^char, arena: ^arena, text: str8) -> ui_text_box_result ---
  ui_select_popup :: proc(name: ^char, info: ^ui_select_popup_info) -> ui_select_popup_info ---
  ui_radio_group :: proc(name: ^char, info: ^ui_radio_group_info) -> ui_radio_group_info ---
}
